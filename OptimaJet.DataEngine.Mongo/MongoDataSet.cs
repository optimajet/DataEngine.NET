...
public class MongoDataSet<TEntity> : IDataSet<TEntity> where TEntity : class
{
    public MongoDataSet(MongoDatabase database, DataSetOptions options)
    {
        MongoDatabase = database;
        Options = options;
    }

    public IDatabase Database => MongoDatabase;
    ...
    protected MongoDatabase MongoDatabase { get; }
    ...
    private IMongoCollection<TEntity> GetCollection() => MongoDatabase.GetCollection<TEntity>(Metadata.Name);
